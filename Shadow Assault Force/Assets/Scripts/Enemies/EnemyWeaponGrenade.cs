    ...
    private void PerformShot()
    {
        ...
        if (Physics.Raycast(transform.position, direction, out _rayHit, _grenadeRange))
        {
            ...
            if (_rayHit.collider.gameObject.tag == "Player")
            {
                ...
                //_enemyGrenadeController.DrawLandingCircle(_enemyGrenadeController._playerGameObject.transform.position);
                _grenageLuncherBarrel.Shoot(_enemyGrenadeController._playerGameObject.transform.position);
            }
